...
<html>
<head>
<title>Dhaka Interantional University</title>
<meta charset="utf-8">
  ...
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a href="search.jsp">Result</a></li>
...
<!-- ################################################################################################ -->
<div class="wrapper">
  <div style="border:1px solid black;padding:10px;margin-top:30px;background:#fff">  
           <%
            String dd= (String) request.getAttribute("update_show");
if (null == dd) {
    
}else{%>

<span class="style"><% out.print(dd);%> </span>
...
%>          
          ...
          <div class="form-group">
            ...
            <level>Semester :</level>
             ...
             <level>Shift</level>
             <label class="radio-inline"><input type="radio" value="day" name="day">Day</label>
             <label class="radio-inline"><input type="radio" value="evening" name="evening">Evening</label>
            <div class="form-group">
            <level>Name :</level>
            ...
            <div class="form-group">
            <level>Roll :</level>
            <input type="text" name="roll" id="" placeholder="Roll" class="form-control">
            </div>
            <div class="form-group">
            <level>GPA :</level>
            <input type="number" step="0.01" name="gpa" id="" placeholder="Name" class="form-control">
            </div>
